            ...
            <table className="brightlocal-table">
              <thead>
                <tr>
                  ...
                  <th className="text-center min-w-[150px]">Total reviews</th>
                  <th className="text-center min-w-[150px]">Sessions</th>
                  <th className="text-center min-w-[150px]">Organic sessions</th>
                  <th className="text-center min-w-[150px]">Connections</th>
                  <th className="text-center min-w-[150px]">Active Sync Alerts</th>
                </tr>
              </thead>
              <tbody>
